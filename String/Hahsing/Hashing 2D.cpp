...
struct  hashing_2D{
    ...
    hashing_2D(int n, int m): n(n), m(m){}
...
// Initialization : hashing_2D *mr_warlock=new hashing_2D(n,m);
// Build arr : mr_warlock->arr[i][j]=(value);
// Build_hash: mr_warlock->build_hash();
// For Query :
        //mr_warlock->p1_d_b=powMod(p1, d-b, M1);
        //mr_warlock->q1_c_a=powMod(q1, c-a, M1);
        //mr_warlock->p2_d_b=powMod(p2, d-b, M2);
        //mr_warlock->q2_c_a=powMod(q2, c-a, M2);
        //mr_warlock->find_hash(a,b,c,d);
// delete (mr_warlock);
